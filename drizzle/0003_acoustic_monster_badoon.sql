...
/*
You're trying to delete PRIMARY KEY(provider,providerAccountId) from 'accounts' table
...
/*
You're trying to add PRIMARY KEY(provider,providerId) to 'accounts' table
